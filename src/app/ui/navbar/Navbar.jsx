  ...
  return (
    ...
    >
      <div className="flex text-white gap-3 justify-center w-1/2 md:w-1/3   items-end ">
        <button className="border bg-green-700 text-sm px-1 py-1 md:px-5 rounded-md md:py-3  font-bold">
          ورود به فارابی زون
        </button>
        <button className="border border-gray-200 text-green-700 px-1 py-1 md:px-2 md:py-3 text-sm font-bold rounded-md">
          فارابیکسو
        </button>
      </div>
