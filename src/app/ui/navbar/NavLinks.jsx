...
const NavLinks = () => {
  ...
  return (
    <>
      {links.map((link) => (
        <div key={link.id}>
          <div className="relative px-3 text-left lg:cursor-pointer group">
            <h1
            ...
            {link.submenu && (
              <div className="">
                <div className="absolute  top-20 right-0  border-t-2 border-[color:var(--bg)] hidden group-hover:lg:block hover:lg:block">
