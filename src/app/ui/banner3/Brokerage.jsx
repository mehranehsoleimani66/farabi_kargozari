...
const Brokerage = () => {
  return (
    <div className="flex flex-col-reverse w-full h-[800px] lg:h-[600px] lg:flex lg:flex-row justify-between items-center lg:px-32 lg:py-28">
      <div className="flex  w-1/2  justify-center items-center ">
        <Chart />
      </div>

      <div className="flex flex-col   flex-1 justify-center items-center text-center lg:items-end lg:text-end gap-8  ">
